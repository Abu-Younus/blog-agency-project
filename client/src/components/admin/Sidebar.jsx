...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div
      className={`w-64 bg-gray-700 text-white flex flex-col justify-between absolute h-full md:static z-10 ${
        isOpen ? "" : "hidden"
      }`}
    >
      {/* Top - Logo */}
      <div className="p-6">
        <button
          className="block md:hidden bg-gray-500 py-2 px-4 cursor-pointer mb-2 rounded-sm"
      ...
      <div className="p-6">
        <button
          ...
          className="flex items-center space-x-2 px-4 py-3 rounded-lg bg-gray-900 hover:bg-gray-500"
        >
          <FaSignOutAlt />
          <span>Logout</span>
        </button>
