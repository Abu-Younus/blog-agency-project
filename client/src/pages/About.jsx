      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 sm:px-12 lg:px-24 flex flex-col lg:flex-row justify-between gap-4">
          ...
          <div className="lg:w-1/2">
            <img
              src="https://images.unsplash.com/photo-1518481612222-68bbe828ecd1?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="About Image"
